...
function reverie_enqueue_style()
{
	...
	if ( is_child_theme() ) {
    // foundation child stylesheet
    wp_register_style( 'reverie-foundation-child-stylesheet', get_stylesheet_directory_uri() . '/css/app.css', array(), '' );
    
    wp_enqueue_style( 'reverie-foundation-child-stylesheet' );
    ...
    // Register custom RootAndFlow.com vanilla CSS style sheet		
		wp_register_style( 'reverie-child-root-and-flow-stylesheet', get_stylesheet_directory_uri() . '/css/styles-root-and-flow.css', array(), '', 'all' );

		wp_enqueue_style( 'reverie-child-root-and-flow-stylesheet' );
	}
}
